...
const task_controller_1 = require("../../api/task/task.controller");
...
exports.taskResolver = {
    Query: {
        tasks: async (_parent, args, context) => {
            ...
            return await (0, task_controller_1.getTasksController)(args.projectId);
        },
    ...
    Mutation: {
        createTask: async (_parent, args, context) => {
            ...
            return await (0, task_controller_1.createTaskController)(title, description, projectId);
        },
        updateTask: async (_parent, args, context) => {
            ...
            return await (0, task_controller_1.updateTaskController)(taskId, title, description, status, projectId);
        },
        deleteTask: async (_parent, args, context) => {
            if (!context.user)
                throw new errors_1.NotFoundUserException();
            (0, auth_1.checkRole)(context.user, [user_interface_1.roleEnum.ADMIN]);
            return await (0, task_controller_1.deleteTaskController)(args.taskId);
        },
    },
    Task: {
